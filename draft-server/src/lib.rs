...
use tracing_honeycomb::{new_honeycomb_telemetry_layer_with_trace_sampling, TelemetryLayer, HoneycombTelemetry, SpanId, TraceId};
...
pub fn setup_logging() -> TelemetryLayer<HoneycombTelemetry<std::sync::Mutex<Client<Transmission>>>, SpanId, TraceId> {
