...
pub struct BlockingSubscriber {
    ...
    inner: crate::client::Subscriber<TcpStream>,
...
struct SubscriberIterator<C> {
    /// The asynchronous `Subscriber`.
    inner: crate::client::Subscriber<C>,
...
/// }
/// ```
pub fn connect<T: ToSocketAddrs>(addr: T) -> crate::Result<BlockingClient<TcpStream>> {
...
impl Iterator for SubscriberIterator<TcpStream> {
